...
void World::Initialize() {
	...
	GameObject obj = GameObject(glm::vec3(3.0f, 5.0f, -5.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 1.0f, 1.0f), AssetManager::GetModel("sphere_default"), AssetManager::GetShader("shader_default_unlit"));
	m_gameObjects.push_back(obj);
	obj = GameObject(glm::vec3(-3.0f, 5.0f, -5.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 1.0f, 1.0f), AssetManager::GetModel("sphere_default"), AssetManager::GetShader("shader_default_unlit"));
	m_gameObjects.push_back(obj);
